...
export const SearchEvent = () => {
    ...
    // Estados para edición en línea The React Way
    ...
    // #region ==== Definición de funciones backend. ====
    ...
    const handleExport = () => {
        ...
        if (htmlTable) {
            // El SpreadsheetManipulator ahora se encarga de clonar y limpiar las acciones internamente
    ...
    const columns = [
        ...
        },
        {
            ...
            accessor: 'actions',
            align: "center",
            className: "actions-column", // Importante para la exportación a excel (para excluirla)
            render: (row) => {
                if (editingRowId === row.eventRegisterId) {
                    return (
